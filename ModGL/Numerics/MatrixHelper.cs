...
namespace ModGL.Numerics
{
    public static class MatrixHelper
    {
        ...
        public static Matrix4f RotateX(float angleInRadians)
        {
            ...
            return new Matrix4f(new Vector4f(1, 0, 0, 0), new Vector4f(0, cs, ss, 0), new Vector4f(0, -ss, cs, 0), new Vector4f(0, 0, 0, 1));
        }
        ...
        public static Matrix4f RotateY(float angleInRadians)
        {
            var cs = (float)Math.Cos(angleInRadians);
            var ss = (float)Math.Sin(angleInRadians);
            return new Matrix4f(new Vector4f(cs, 0, -ss, 0), new Vector4f(0, 1, 0, 0), new Vector4f(ss, 0, cs, 0), new Vector4f(0, 0, 0, 1));
        }
        ...
        public static Matrix4f RotateZ(float angleInRadians)
        {
            var cs = (float)Math.Cos(angleInRadians);
            var ss = (float)Math.Sin(angleInRadians);
            return new Matrix4f(new Vector4f( cs, ss, 0, 0), new Vector4f(-ss, cs, 0, 0), new Vector4f(0, 0, 1, 0), new Vector4f(0, 0, 0, 1) );
        }
